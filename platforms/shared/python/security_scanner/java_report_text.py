...
_TEXT: Final[dict[ReportLanguage, dict[str, str]]] = {
    "en": {
        ...
        "locations": "Locations",
        "fixed_candidates": "Fixed candidates",
        "final_trace": "Final verification",
        "checked_versions": "Checked versions",
        "match_evidence": "Match evidence",
        "no_description": "No NVD description was supplied in the offline data.",
    },
    "ko": {
        ...
        "references": "참고 링크",
        "locations": "발견 위치",
        "fixed_candidates": "수정 버전 후보",
        "final_trace": "최종 버전 검증",
        "checked_versions": "확인한 버전",
        "match_evidence": "매칭 근거",
        "no_description": "오프라인 데이터에 NVD 설명이 없습니다.",
    },
}
