...
class ScannerTests(unittest.TestCase):
    ...
    def test_platform_launchers_start_app_mode(self) -> None:
        ...
        self.assertIn("SeverityDistribution", koda_bridge.read_text(encoding="utf-8"))
        ...
        self.assertIn("RiskScoreOverviewPanel", koda_content_view.read_text(encoding="utf-8"))
        self.assertIn("SeverityDistributionChart", koda_content_view.read_text(encoding="utf-8"))
        ...
        self.assertIn("DetailHelpPanel", koda_standards_view.read_text(encoding="utf-8"))
